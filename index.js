...
// Ripped from https://github.com/shuhei/material-colors/blob/master/dist/colors.js
var colours = {
...
_.forEach(colours, function(obj, colour) {
  _.forEach(obj, function(hex, label) {
    if( label[0] !== 'a') {
      var color = Tinycolor(hex).toRgb()
      var png = new MicroPNG(1, 1)
      var filename = colour + '-' + label
      png.background([color.r,color.g,color.b])
      png.exportFile(__dirname + '/colours/' + filename + '.png')
    }
  })
})
